...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/landing/img/apple-icon.png"> 
        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:info@company.com">infoallpink@gmail.com</a>
